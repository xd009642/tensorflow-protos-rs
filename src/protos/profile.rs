...
//! Generated file from `tensorflow/core/profiler/profile.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&tensorflow/core/profiler/profile.proto\x12\x17tensorflow.tfprof.pprof\
    \"\x93\x05\n\x07Profile\x12C\n\x0bsample_type\x18\x01\x20\x03(\x0b2\".te\
    nsorflow.tfprof.pprof.ValueTypeR\nsampleType\x127\n\x06sample\x18\x02\
    \x20\x03(\x0b2\x1f.tensorflow.tfprof.pprof.SampleR\x06sample\x12:\n\x07m\
    apping\x18\x03\x20\x03(\x0b2\x20.tensorflow.tfprof.pprof.MappingR\x07map\
    ping\x12=\n\x08location\x18\x04\x20\x03(\x0b2!.tensorflow.tfprof.pprof.L\
    ocationR\x08location\x12=\n\x08function\x18\x05\x20\x03(\x0b2!.tensorflo\
    w.tfprof.pprof.FunctionR\x08function\x12!\n\x0cstring_table\x18\x06\x20\
    \x03(\tR\x0bstringTable\x12\x1f\n\x0bdrop_frames\x18\x07\x20\x01(\x03R\n\
    dropFrames\x12\x1f\n\x0bkeep_frames\x18\x08\x20\x01(\x03R\nkeepFrames\
    \x12\x1d\n\ntime_nanos\x18\t\x20\x01(\x03R\ttimeNanos\x12%\n\x0eduration\
    _nanos\x18\n\x20\x01(\x03R\rdurationNanos\x12C\n\x0bperiod_type\x18\x0b\
    \x20\x01(\x0b2\".tensorflow.tfprof.pprof.ValueTypeR\nperiodType\x12\x16\
    \n\x06period\x18\x0c\x20\x01(\x03R\x06period\x12\x18\n\x07comment\x18\r\
    \x20\x03(\x03R\x07comment\x12.\n\x13default_sample_type\x18\x0e\x20\x01(\
    \x03R\x11defaultSampleType\"3\n\tValueType\x12\x12\n\x04type\x18\x01\x20\
    \x01(\x03R\x04type\x12\x12\n\x04unit\x18\x02\x20\x01(\x03R\x04unit\"u\n\
    \x06Sample\x12\x1f\n\x0blocation_id\x18\x01\x20\x03(\x04R\nlocationId\
    \x12\x14\n\x05value\x18\x02\x20\x03(\x03R\x05value\x124\n\x05label\x18\
    \x03\x20\x03(\x0b2\x1e.tensorflow.tfprof.pprof.LabelR\x05label\"=\n\x05L\
    abel\x12\x10\n\x03key\x18\x01\x20\x01(\x03R\x03key\x12\x10\n\x03str\x18\
    \x02\x20\x01(\x03R\x03str\x12\x10\n\x03num\x18\x03\x20\x01(\x03R\x03num\
    \"\xd7\x02\n\x07Mapping\x12\x0e\n\x02id\x18\x01\x20\x01(\x04R\x02id\x12!\
    \n\x0cmemory_start\x18\x02\x20\x01(\x04R\x0bmemoryStart\x12!\n\x0cmemory\
    _limit\x18\x03\x20\x01(\x04R\x0bmemoryLimit\x12\x1f\n\x0bfile_offset\x18\
    \x04\x20\x01(\x04R\nfileOffset\x12\x1a\n\x08filename\x18\x05\x20\x01(\
    \x03R\x08filename\x12\x19\n\x08build_id\x18\x06\x20\x01(\x03R\x07buildId\
    \x12#\n\rhas_functions\x18\x07\x20\x01(\x08R\x0chasFunctions\x12#\n\rhas\
    _filenames\x18\x08\x20\x01(\x08R\x0chasFilenames\x12(\n\x10has_line_numb\
    ers\x18\t\x20\x01(\x08R\x0ehasLineNumbers\x12*\n\x11has_inline_frames\
    \x18\n\x20\x01(\x08R\x0fhasInlineFrames\"\x86\x01\n\x08Location\x12\x0e\
    \n\x02id\x18\x01\x20\x01(\x04R\x02id\x12\x1d\n\nmapping_id\x18\x02\x20\
    \x01(\x04R\tmappingId\x12\x18\n\x07address\x18\x03\x20\x01(\x04R\x07addr\
    ess\x121\n\x04line\x18\x04\x20\x03(\x0b2\x1d.tensorflow.tfprof.pprof.Lin\
    eR\x04line\";\n\x04Line\x12\x1f\n\x0bfunction_id\x18\x01\x20\x01(\x04R\n\
    functionId\x12\x12\n\x04line\x18\x02\x20\x01(\x03R\x04line\"\x8a\x01\n\
    \x08Function\x12\x0e\n\x02id\x18\x01\x20\x01(\x04R\x02id\x12\x12\n\x04na\
    me\x18\x02\x20\x01(\x03R\x04name\x12\x1f\n\x0bsystem_name\x18\x03\x20\
    \x01(\x03R\nsystemName\x12\x1a\n\x08filename\x18\x04\x20\x01(\x03R\x08fi\
    lename\x12\x1d\n\nstart_line\x18\x05\x20\x01(\x03R\tstartLineb\x06proto3\
";
